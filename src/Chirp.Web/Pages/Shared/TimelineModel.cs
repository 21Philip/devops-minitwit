...
{
    public TimelineModel(ICheepRepository cheepRepository, IAuthorRepository authorRepository, ILogger<TimelineModel> logger)
    {
    ...
    protected ILogger<TimelineModel> Logger { get; }
    ...
    public async Task<ActionResult> OnPost()
    {
        ...
        {
            this.Logger.LogWarning("Rejected timeline cheep creation because no authenticated author name was present");
    ...
    public async Task<ActionResult> OnPostFollow(string followAuthorName)
    {
        ...
        if (string.IsNullOrEmpty(authorName))
        {
            this.Logger.LogWarning("Rejected timeline follow action because no authenticated author email was present");
            throw new ArgumentException("Author name cannot be null or empty.");
        }
    ...
    public async Task<ActionResult> OnPostUnfollow(string followAuthorName)
    {
        ...
        if (string.IsNullOrEmpty(authorName))
        {
            this.Logger.LogWarning("Rejected timeline unfollow action because no authenticated author name was present");
            throw new ArgumentException("Author name cannot be null or empty.");
        }
        ...
        this.Logger.LogInformation("User {AuthorName} unfollowed {FollowAuthorName} from timeline", author.Name, followAuthor.Name);
    ...
    public async Task<ActionResult> OnPostLike(string cheepAuthorName, string text, string timeStamp)
    {
        ...
        if (string.IsNullOrEmpty(authorName))
        {
            this.Logger.LogWarning("Rejected timeline like action because no authenticated author name was present");
            throw new ArgumentException("Author name cannot be null or empty.");
        }
        ...
        this.Logger.LogInformation("User {AuthorName} liked timeline cheep by {CheepAuthorName} at {CheepTimestamp}", author.Name, cheepAuthorName, timeStamp);
    ...
    public async Task<ActionResult> OnPostUnLike(string cheepAuthorName, string text, string timeStamp)
    {
        ...
        if (string.IsNullOrEmpty(authorName))
        {
            this.Logger.LogWarning("Rejected timeline unlike action because no authenticated author name was present");
            throw new ArgumentException("Author name cannot be null or empty.");
        }
        ...
        this.Logger.LogInformation("User {AuthorName} removed like from timeline cheep by {CheepAuthorName} at {CheepTimestamp}", author.Name, cheepAuthorName, timeStamp);
