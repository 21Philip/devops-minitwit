...
{
    public UserTimelineModel(ICheepRepository cheepRepository, IAuthorRepository authorRepository, ILogger<UserTimelineModel> logger)
    ...
    public async Task<ActionResult> OnGet()
    {
        ...
        this.Logger.LogInformation("Loading timeline view for route author {PageUser} by viewer {AuthorName}", pageUser, authorName);
        ...
        else
        {
            ...
            this.Logger.LogInformation("Loaded user timeline for route author {PageUser} with {CheepCount} cheeps", pageUser, this.Cheeps.Count);
            return this.Page();
        }
    }
}
